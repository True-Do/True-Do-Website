        ...
        <div className='w-1/2 '>
          ...
          <form className='flex flex-col'>
            ...
            <div className='flex flex-row justify-center mt-4'>
              <Button
                variant='secondary'
                className='bg-text-light text-white shadow-black hover:bg-text-light hover:shadow-md transition-all w-full mr-3'
                size='sm'
                formAction={login}
              >
                Log in
              ...
              <Button
                variant='secondary'
                size='sm'
                className='bg-text-light text-white hover:bg-text-light hover:shadow-md transition-all w-full'
                formAction={signup}
              >
                Sign up
              </Button>
          ...
          <div className='flex flex-col space-y-2 mt-4'>
            <button
              ...
              className='w-full px-4 py-2 text-base border flex items-center gap-2 border-slate-400 dark:border-slate-700 rounded-lg text-slate-700 dark:text-slate-200 hover:border-slate-400 dark:hover:border-slate-500 hover:text-slate-900 dark:hover:text-slate-300 hover:shadow transition duration-150'
            >
              <Image
                width={1}
                height={1}
